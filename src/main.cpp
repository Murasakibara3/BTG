...
int64 nChainStartTime = 1487399433;
...
const string strMessageMagic = "BITTOU COIN Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if(nPoWHeight == 1)	 nSubsidy = 40000000 * COIN;
     else         	      	 nSubsidy = 0 * COIN;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    if(nHeight < 1 * YEARLY_POS_BLOCK_COUNT)        nSubsidy *= 5;
    else                                            nSubsidy = 0;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BITTOU COIN
    bool fStrictPayToScriptHash = true; // Always active in BITTOU COIN
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BITTOU COIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2017.02.18 BITTOU COIN";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("c58230cbe338de7f63463654c41b503e3e49adcfadf94f8b2e206f2ac8f45a9d"));
